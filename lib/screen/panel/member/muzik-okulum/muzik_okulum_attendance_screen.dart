...
/// Müzik okulu üye paneli — yoklama geçmişi.
///
...
class MuzikOkulumAttendanceScreen extends StatefulWidget {
  const MuzikOkulumAttendanceScreen({super.key});

  @override
  State<MuzikOkulumAttendanceScreen> createState() =>
      _MuzikOkulumAttendanceScreenState();
}

class _MuzikOkulumAttendanceScreenState
    extends State<MuzikOkulumAttendanceScreen> {
      ...
      if (result.isSuccess && result.body is Map<String, dynamic>) {
        ...
        if (output is Map<String, dynamic>) {
          if (kDebugMode) {
            try {
              debugPrint(
                '[MuzikOkulumAttendance] attendance-report raw output:\n'
                '${const JsonEncoder.withIndent('  ').convert(output)}',
              );
            } catch (_) {
              debugPrint(
                '[MuzikOkulumAttendance] attendance-report output: $output',
              );
            }
          }
