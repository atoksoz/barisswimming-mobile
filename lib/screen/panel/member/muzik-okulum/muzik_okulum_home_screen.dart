...
import 'package:e_sport_life/screen/panel/member/muzik-okulum/muzik_okulum_home_reminders_section.dart';
import 'package:e_sport_life/screen/panel/member/muzik-okulum/muzik_okulum_home_summary_section.dart';
...
class MuzikOkulumHomeScreen extends StatefulWidget {
  const MuzikOkulumHomeScreen({Key? key}) : super(key: key);

  @override
  State<MuzikOkulumHomeScreen> createState() => _MuzikOkulumHomeScreenState();
}

class _MuzikOkulumHomeScreenState extends State<MuzikOkulumHomeScreen> {
  static const String _cacheKeyDashboard = 'muzik_okulum_full_dashboard';
                        ...
                        MuzikOkulumHomeSummarySection(
                          ...
                          onActivePackagesTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const PackageListScreen(activeOnly: true),
                              ),
                            );
                          },
                          onWeekLessonsTap: () {
                            MemberTodaySummaryPopup.showThisWeekLessons(context);
                          },
                          onOverdueTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const PaymentPlanListScreen(
                                  showOverduePaymentsOnly: true,
                                ),
                              ),
                            );
                          },
                          onNextLessonTap: () {
                            final next = _homeInsights?.nextLesson;
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => LessonScheduleScreen(
                          ...
                          onRecentAttendanceTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const MuzikOkulumAttendanceScreen(),
                              ),
                            );
                          },
                        ),
                        MuzikOkulumHomeRemindersSection(
