...
const bool _kMuzikOkulumProfileForceAllowMemberInfoEdit = true;

/// Profil fotoğrafı güncelleme ayarı kapalı olsa bile test için açılır.
/// Canlıya çıkmadan önce `false` yapın.
const bool _kMuzikOkulumProfileForceAllowPhotoUpdate = true;
...
// Müzik okulu profili: doğum tarihi girişi (dd-MM-yyyy)
...
/// Müzik okulu üye profili: doğum tarihi `dd-MM-yyyy`, dolap şifresi alanı yok.
class MuzikOkulumMemberProfileScreen extends StatefulWidget {
  const MuzikOkulumMemberProfileScreen({Key? key}) : super(key: key);

  static const String id = 'Müzik Okulu Profili';

  @override
  State<MuzikOkulumMemberProfileScreen> createState() =>
      _MuzikOkulumMemberProfileScreenState();
}

class _MuzikOkulumMemberProfileScreenState
    extends State<MuzikOkulumMemberProfileScreen> {
