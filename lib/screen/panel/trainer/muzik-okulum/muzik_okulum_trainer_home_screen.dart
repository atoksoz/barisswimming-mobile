...
import 'package:e_sport_life/screen/panel/trainer/muzik-okulum/muzik_okulum_trainer_lessons_list_screen.dart';
import 'package:e_sport_life/screen/panel/trainer/muzik-okulum/muzik_okulum_trainer_weekly_stats_screen.dart';
...
/// Geçici: eğitmen yoklama alma (kart kısayolu, roster ekranı) kapalı — tekrar açılınca [false] yapın.
const bool _kMuzikOkulumBypassAttendanceTaking = true;

class MuzikOkulumTrainerHomeScreen extends StatefulWidget {
  const MuzikOkulumTrainerHomeScreen({super.key});

  @override
  State<MuzikOkulumTrainerHomeScreen> createState() =>
      _MuzikOkulumTrainerHomeScreenState();
}

class _MuzikOkulumTrainerHomeScreenState extends State<MuzikOkulumTrainerHomeScreen> {
  ...
  Widget _buildTopSummaryCards(BaseTheme theme, AppLabels labels) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute<void>(
          builder: (_) => TrainerLessonScheduleScreen(
            ...
            allowScheduleMutations: false,
            servicePlanRosterAttendance: true,
            showRegisteredParticipantsOnCapacityTap: true,
            skipAttendanceTaking: _kMuzikOkulumBypassAttendanceTaking,
          ),
        ),
      );
    }
    ...
    void openTodayAttendancePopup() {
      ...
      if (d == null) return;
      TrainerTodayDashboardDialogs.showTodayAttendance(
        context,
        d,
        showAttendanceLessonName: true,
      );
    }
            ...
            child: Row(
              children: [
                ...
                iconButtonWidget(
                  ...
                  iconColor: _kMuzikOkulumBypassAttendanceTaking
                      ? theme.defaultGray400Color
                      : null,
                  onTap: _kMuzikOkulumBypassAttendanceTaking
                      ? () {}
  ...
  // ─── Hızlı erişim: Ders Programı, Verdiğim Dersler, Haftalık Ders Özeti ───
  ...
  Widget _buildQuickAccessSection(BaseTheme theme, AppLabels labels) {
    ...
    void pushWeeklyStats() {
      if (!_guardActive()) return;
      Navigator.push<void>(
        context,
        MaterialPageRoute<void>(
          builder: (_) => const MuzikOkulumTrainerWeeklyStatsScreen(),
        ),
      );
    }
    ...
    void pushMyLessons() {
      ...
      Navigator.push<void>(
        context,
        MaterialPageRoute<void>(
          builder: (_) => const MuzikOkulumTrainerLessonsListScreen(),
        ),
      );
    }
      ...
      children: [
        Row(
          children: [
            iconButtonWidget(
              icon: Icons.calendar_month_outlined,
              text: labels.trainerQuickAccessLessonScheduleTitle,
              iconWidth: 45,
              iconHeight: 40,
              centerText: true,
            ...
            iconButtonWidget(
              ...
              text: labels.trainerCardQuickMyLessons,
              iconWidth: 45,
              iconHeight: 40,
              centerText: true,
              iconColor: theme.default900Color,
            ...
            iconButtonWidget(
              ...
              text: labels.trainerCardQuickWeeklyStats,
              iconWidth: 45,
              iconHeight: 40,
              centerText: true,
              iconColor: theme.default900Color,
              onTap: pushWeeklyStats,
              margin: const EdgeInsetsDirectional.fromSTEB(10, 0, 10, 0),
            ),
          ],
        ),
