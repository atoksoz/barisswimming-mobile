...
class _TrainerProfileEditScreenState extends State<TrainerProfileEditScreen> {
    ...
    return Padding(
      ...
      child: OutlinedButton.icon(
        ...
        style: OutlinedButton.styleFrom(
          side: BorderSide(color: theme.default300Color),
            ...
            child: InputDecorator(
              ...
              child: _selectedProfessions.isEmpty
                  ...
                  : Wrap(
                      spacing: 8,
                      runSpacing: 6,
                      children: _selectedProfessions.map((key) {
                        final label = professionLabels[key] ??
                            EmployeeProfession.getLabel(key);
                        return Container(
  ...
  void _showProfessionBottomSheet(dynamic theme, AppLabels labels) {
    final professionLabels = labels.professionLabels;
    final items = _availableProfessions.isNotEmpty
        ? _availableProfessions
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: theme.inputDecoration(
          labelText: label,
          hintText: hintText,
          prefixIcon: Icon(icon, color: theme.default700Color, size: 22),
        ),
      ),
    );
  }
