...
class PtPackageHistoryDetailScreen extends StatefulWidget {
  const PtPackageHistoryDetailScreen({Key? key}) : super(key: key);

  @override
  State<PtPackageHistoryDetailScreen> createState() => _PtPackageHistoryDetailScreenState();
}

class _PtPackageHistoryDetailScreenState extends State<PtPackageHistoryDetailScreen> {
  Future<List<PackageModel>> fetchPtPackageData() async {
    ...
    try {
      ...
      final extractUrl = HamamSpaUrlConstants.getPtMemberRegisterUrl(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TopAppBarWidget(
        title: "Satın Alınan PT Paketleri",
      ),
      body: Column(
        children: <Widget>[
          Expanded(
            child: FutureBuilder<List<PackageModel>>(
              future: fetchPtPackageData(),
