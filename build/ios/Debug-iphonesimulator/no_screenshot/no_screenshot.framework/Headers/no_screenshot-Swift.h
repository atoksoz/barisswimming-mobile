...
#ifndef NO_SCREENSHOT_SWIFT_H
#define NO_SCREENSHOT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="no_screenshot",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class FlutterError;
SWIFT_CLASS("_TtC13no_screenshot21IOSNoScreenshotPlugin")
@interface IOSNoScreenshotPlugin : NSObject <FlutterPlugin, FlutterStreamHandler>
